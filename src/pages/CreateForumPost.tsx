...
const titlePrompts: Record<string, string[]> = {
  general: [
    'แชร์ประสบการณ์การเลี้ยงแมวในคอนโด',
    'ขอคำแนะนำเรื่องการดูแลแมวสูงวัย',
    'พูดคุยเรื่องนิสัยแปลก ๆ ของเจ้าเหมียว',
  ],
  adoption: [
    'ประกาศตามหาบ้านใหม่ให้แมวที่คุณดูแลอยู่',
    'แชร์ประสบการณ์การรับเลี้ยงแมวจากศูนย์ช่วยเหลือ',
    'ถาม-ตอบเรื่องการเตรียมบ้านก่อนรับเลี้ยง',
  ],
  health: [
    'อัปเดตอาการหลังพาแมวไปพบสัตวแพทย์',
    'สอบถามเรื่องวัคซีนหรือยาถ่ายพยาธิ',
    'วิธีดูแลแมวที่ป่วยหรือเพิ่งผ่าตัด',
  ],
  behavior: [
    'เจ้าเหมียวไม่ยอมใช้กระบะทรายควรทำอย่างไร',
    'เรื่องตลก ๆ จากนิสัยของน้องแมว',
    'วิธีรับมือกับแมวขี้กังวลหรือขี้ตกใจ',
  ],
  nutrition: [
    'แนะนำอาหารเม็ด/เปียกที่แมวชอบกิน',
    'ถามเรื่องการจัดมื้อสำหรับแมวที่แพ้อาหาร',
    'แชร์สูตรขนมโฮมเมดสำหรับน้องแมว',
  ],
};
